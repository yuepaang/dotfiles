...
local plug_map = {
    ...
    ["n|<Leader>ee"] = map_cr("lua require('telescope.builtin').diagnostics({ignore_filename=true})"):with_noremap()
        :with_silent(),
    ...
    ["n|<Leader>fh"] = map_cr('Telescope projects'):with_noremap(),
    ...
    ["v|<Leader>cc"] = map_cu('lua require("Comment.api").toggle_linewise_op(vim.fn.visualmode())'):with_noremap()
        :with_silent(),
    ["v|<Leader>b"] = map_cu('lua require("Comment.api").toggle_blockwise_op(vim.fn.visualmode())'):with_noremap()
        :with_silent(),
