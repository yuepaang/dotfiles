...
plug_map.normal = {
    ...
    ["g"] = {
        ...
        d = bind.convert_wk_format(
            map_cr("lua require('extend.lsp').lsp_definitions()")
                :with_noremap()
                :with_silent()
        ...
        t = bind.convert_wk_format(
            map_cr("lua require('extend.lsp').lsp_type_definition()")
                :with_noremap()
                :with_silent()
                :with_label("Go To Type Definition")
        ),
        i = bind.convert_wk_format(
            map_cr("lua require('extend.lsp').lsp_implementations()")
                :with_noremap()
                :with_silent()
                :with_label("Go To Implementation")
        ),
        r = bind.convert_wk_format(
            map_cr("lua require('extend.lsp').lsp_references()")
                :with_noremap()
                :with_silent()
        ...
        a = bind.convert_wk_format(
            map_cr("lua require('cosmic-ui').code_actions()"):with_noremap():with_silent():with_label("Code Action")
        ),
        ...
        n = bind.convert_wk_format(
            map_cr("lua require('cosmic-ui').rename()"):with_noremap():with_silent():with_label("Rename")
        ),
    },
    ...
    ["<leader>v"] = {
        ...
        v = bind.convert_wk_format(
            map_cu('lua require"symbols-outline".toggle_outline()')
                :with_noremap()
                :with_silent()
    ...
    ["<leader>d"] = {
        ...
        t = bind.convert_wk_format(
            map_cr("lua require('extend.diagnostics').toggle_virtual_text()")
                :with_noremap()
                :with_silent()
    ...
    ["f"] = {
        ...
        r = bind.convert_wk_format(
            map_cu("FloatermNew --cwd=<root>")
                :with_noremap()
                :with_silent()
                :with_label("Open Floaterm In Project Rood Dir")
        ),
        v = bind.convert_wk_format(
    ...
    ["<leader>f"] = {
        ...
        d = bind.convert_wk_format(
            map_cr("Telescope neoclip"):with_noremap():with_label("Find Saved Buffer In Clipboard")
        ),
    },
    ...
    ["<leader>s"] = {
        name = "Search Word",
        w = bind.convert_wk_format(
            map_cr("lua require'hop'.hint_words()"):with_noremap():with_silent():with_label("Search Word")
        ),
        s = bind.convert_wk_format(
            map_cu("lua require'hop'.hint_char2()"):with_noremap():with_silent():with_label("Search By First 2 Char")
        ),
    },
...
plug_map.visual = {
    ["g"] = {
        ...
        a = bind.convert_wk_format(
            map_cu("lua require('cosmic-ui').range_code_actions()")
                :with_noremap()
                :with_silent()
    ...
    ["<leader>l"] = {
        ...
        l = bind.convert_wk_format(
            map_cu("VBox"):with_noremap():with_silent():with_label("Normal Line"):with_mode("v")
        ),
        d = bind.convert_wk_format(
            map_cu("VBoxD"):with_noremap():with_silent():with_label("Double Line"):with_mode("v")
        ),
    ...
    ["<C-Space>"] = bind.convert_wk_format(
        map_cu("WhichKey '' v"):with_noremap():with_label("Show Keymaps"):with_mode("v")
    ),
}

plug_map.insert = {
    ["<C-Space>"] = bind.convert_wk_format(
        map_cmd("<Esc>:WhichKey '' i<CR>"):with_noremap():with_label("Show Keymaps"):with_mode("i")
    ),
}
