...
map.Diagnostic = {
    n = {
        ["<leader>d"] = {
            ...
            d = map_cr("Telescope diagnostics bufnr=0")
            :with_noremap()
            :with_silent()
...
map.Dap = {
    n = {
        ["<F12>"] = map_cr('lua require("doodleVim.extend.hydra").run("dap")')
        :with_noremap()
        :with_silent()
...
map.Default = {
    n = {
        ...
        ["<Esc><Esc>"] = map_cr(':nohlsearch<CR>')
        :with_noremap()
        :with_silent()
        :with_label("Cancel highlight search"),
