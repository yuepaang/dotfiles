...
plug_map.normal = {
    ["<leader>"] = {
        name = "leader",
        e = bind.convert_wk_format(map_cr("lua require('doodleVim.extend.tree').toggle()"):with_noremap():with_silent():with_label("Enhanced NvimTree Toggle"))
    },
    ["t"] = {
    ...
    ["g"] = {
        ...
        f = bind.convert_wk_format(map_cr("lua vim.lsp.buf.format({async=true})"):with_noremap():with_silent():with_label("Code Formatting")),
