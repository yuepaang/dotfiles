...
function config.gotools()
    ...
    require("dressing.select.telescope").custom_kind["gotools"] =
        function(opts, defaults, items)
...
function config.null_ls()
    ...
    null_ls.setup({
        ...
        require("gotools").code_actions.gotests, require("gotools").code_actions.gomodifytags,
        require("gotools").code_actions.impl, null_ls.builtins.code_actions.gitsigns,
        null_ls.builtins.diagnostics.solhint, null_ls.builtins.formatting.xmlformat.with({
            extra_args = {"--indent", "4"}
        })},
    ...
    require("fidget").setup({
        ...
        fmt = {
            ...
            task = function(task_name, message, percentage)
                return string.format("%s%s [%s]", message, percentage and string.format(" (%s%%)", percentage) or "",
                    task_name)
            end
        }
    })
