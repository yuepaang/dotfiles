...
editor["junegunn/vim-easy-align"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").defer_load("vim-easy-align", 200)
  end,
}
...
editor["karb94/neoscroll.nvim"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").register("neoscroll", "neoscroll.nvim")
  end,
...
editor["phaazon/hop.nvim"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").register("hop", "hop.nvim")
  end,
  config = conf.hop,
}
...
editor["lukas-reineke/indent-blankline.nvim"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").add("indent-blankline.nvim", 89)
  end,
...
editor["nvim-lualine/lualine.nvim"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").add("lualine.nvim", 89)
  end,
  config = conf.lualine,
}
...
editor["lewis6991/gitsigns.nvim"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").add("gitsigns.nvim", 89)
  end,
