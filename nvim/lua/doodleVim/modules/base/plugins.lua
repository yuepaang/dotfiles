...
base["nvim-tree/nvim-web-devicons"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").add("nvim-web-devicons", 100)
  end,
}
...
base["nvim-lua/plenary.nvim"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").add("plenary.nvim", 100)
  end,
}
...
base["neovim/nvim-lspconfig"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").add("nvim-lspconfig", 99)
  end,
}
