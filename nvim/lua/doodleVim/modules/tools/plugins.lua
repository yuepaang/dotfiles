...
tools["doodleEsc/which-key.nvim"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").packer_defer_load("which-key.nvim", 100)
  end,
...
tools["AckslD/nvim-neoclip.lua"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").add("nvim-neoclip.lua", 80)
  end,
  config = conf.neoclip,
}
...
tools["aserowy/tmux.nvim"] = {
  opt = true,
  setup = function()
    require("doodleVim.utils.defer").add("tmux.nvim", 80)
  end,
  config = conf.tmux,
}
